...
var endGame = function() {
    // if player is still alive, plsyer wins!
    if (playerInfo.health > 0) {
    ...
    var playAgaintConfirm = window.confirm("Would you like to play again?");
    if (playAgaintConfirm) {
      // restart the game 
      startGame();
    }
    else {
  ...
  var shop = function () {
    ...
    switch (shopOptionPrompt) {
      ...
      //  call sho() again to force player to pick a valid option
      shop();
      break;
    }
  };
...
//     var pickedenemy.names = enemy.names[i];
//     enemy.health = 50;
//     fight(enemy.names[i]);
// }
